...
let lienzo = document.querySelector('.inicio');

function crearEstrellas(){
  const estrella = document.createElement('span');

  let size = Math.random() * 1;
  estrella.style.width = 2 + size + 'px';
  estrella.style.height = 2 + size + 'px';
...
let i = 0;
let j = 0;
const puestos = ["Full Stack       ", "Back End       ", "Front End      ", "Web        ", "De Software       "]
